 ...
 * Module dependencies
 */
let FetchAnEventApart = require('./fetchaneventapart');
let FetchBrooklynJS = require('./fetchbrooklyn');
let FetchCascadiaFest = require('./fetchcascadia');
let FetchCSSConf = require('./fetchcssconf');
let FetchEmpireJS = require('./fetchempire');
let FetchJSConfHU = require('./fetchjsconfhu');
let FetchJSConfUS = require('./fetchjsconfus');
let FetchManhattanJS = require('./fetchmanhattan');
let FetchOpenVis = require('./fetchopenvis');
let FetchSmashingConf = require('./fetchsmashingconf');
...
module.exports = {
  ...
  'vis': {
    ...
    'fetch': FetchOpenVis,
    'url': 'https://openvisconf.com/2015/',
  },
};
